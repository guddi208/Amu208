...
public class CSMC2 extends ConfigFileReader {

	private static final Logger logger = Logger.getLogger(CSMC2.class.getName());
	String session_id;

	@Test(priority = 0, enabled = true)
	public void csmcConnect() throws IOException {
		...
		try {
			...
			ConfigFileReader.writecsmcSessionPropertyFile();
			String connector_key_value = csmcconn.getProperty("connector_key");
			System.out.println("conn" + connector_key_value);
			logger.info("*******************CSMC-CONNECTOR KEY IS :" + connector_key_value);

			//////// Read Json file into JSONObject
			JSONParser parser = new JSONParser();
			JSONObject jObj = null;
			try {
				jObj = (JSONObject) parser.parse(new FileReader(new File(
						System.getProperty("user.dir") + "\\CSMC-Connector\\com\\gcc\\connector\\Json\\CSMC.json")));
...
/////////////////////////////job id ///////////////////////////////////////
	...
	public void submissionCSMCstatus() throws IOException {
