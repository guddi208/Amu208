...
public class AKENEO2 extends ConfigFileReader {

	private static final Logger logger = Logger.getLogger(AKENEO2.class.getName());
	String session_id;

	@Test(priority = 0, enabled = true)
	public void akeneoConnect() throws IOException {
		...
		try {
			...
			try {
				jObj = (JSONObject) parser.parse(new FileReader(new File(System.getProperty("user.dir")
						+ "\\AKENEO-Connector\\com\\gcc\\connector\\Json\\AKENEO.json")));
...
/////////////////////////////job id ///////////////////////////////////////
	...
	public void submissionAKENEOstatus() throws IOException {
